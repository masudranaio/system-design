...
| Parking Lot + Amazon Locker Checklists | [2026-08-26-parking-lot-amazon-locker-checklists.md](2026-08-26-parking-lot-amazon-locker-checklists.md) | **In progress** | — | 2 independent tasks, research already done (WebSearch against real sources, embedded in the plan) — pure transcription into `CHECKLIST.md` format, same shape as Ticketmaster's. Produces `content/04-case-studies/parking-lot/CHECKLIST.md` (CS-03) and `content/04-case-studies/amazon-locker/CHECKLIST.md` (CS-06). Dispatched for full execution 2026-08-26. |
